...
6. Settings. Package configuration reads one dictionary, `settings.COMMUNITY_BASE`, with
   ...
   `COURSEWORK_OPTIONAL_REVIEW_ADDED`, `COURSEWORK_OPTIONAL_REVIEW_DELETED`,
   `COURSEWORK_PEER_REVIEWS_ASSIGNED`, `COURSEWORK_PEER_REVIEWS_ASSIGNMENT_FAILED`,
   `COURSEWORK_PROJECT_LEADERBOARD_UPDATER`, `COURSEWORK_PROJECT_SCORED`,
   `COURSEWORK_PROJECT_SCORING_FAILED`, `JOBS_BACKEND`,
