...
| `D3.1a` | DataTalksClub/website | Additive extension schema (courses.LearnerProfile + accounts_ext) | C5.2a | no | in-progress | https://github.com/DataTalksClub/website/issues/390 — rebased onto current main as branch `d3.1a-rebased` (64bf993f); 0 new failures in both label groups and tests_ci, fresh-database migrate and reverse verified. Originals kept intact. Cannot land until DTC main is green, which is not D3.1's doing: main carries 8 failures, 29 review_import errors from courses.0012_course_prerequisites landing NOT NULL without the fixture following, and 3 tests_ci ownership failures for the three apps carved out of events. Still needs the P14 Postgres rehearsal |
| `D3.1b` | DataTalksClub/website | Switch course-platform readers to courses.LearnerProfile | D3.1a | no | in-progress | https://github.com/DataTalksClub/website/issues/391 — rebased onto current main as branch `d3.1b-rebased` (ad593786); 0 new failures in both label groups and tests_ci, fresh-database migrate and reverse verified. Originals kept intact. Cannot land until DTC main is green, which is not D3.1's doing: main carries 8 failures, 29 review_import errors from courses.0012_course_prerequisites landing NOT NULL without the fixture following, and 3 tests_ci ownership failures for the three apps carved out of events. Still needs the P14 Postgres rehearsal |
| `D3.1c` | DataTalksClub/website | Switch identity-window readers to accounts_ext.IdentityState | D3.1b | no | in-progress | https://github.com/DataTalksClub/website/issues/392 — rebased onto current main as branch `d3.1c-rebased` (70544ec1); 0 new failures in both label groups and tests_ci, fresh-database migrate and reverse verified. Originals kept intact. Cannot land until DTC main is green, which is not D3.1's doing: main carries 8 failures, 29 review_import errors from courses.0012_course_prerequisites landing NOT NULL without the fixture following, and 3 tests_ci ownership failures for the three apps carved out of events. Still needs the P14 Postgres rehearsal |
| `D3.1d` | DataTalksClub/website | Remove the twelve moved fields from CustomUser (contract) | D3.1c | no | in-progress | https://github.com/DataTalksClub/website/issues/393 — rebased onto current main as branch `d3.1d-rebased` (a7806e97); 0 new failures in both label groups and tests_ci, fresh-database migrate and reverse verified. Originals kept intact. Cannot land until DTC main is green, which is not D3.1's doing: main carries 8 failures, 29 review_import errors from courses.0012_course_prerequisites landing NOT NULL without the fixture following, and 3 tests_ci ownership failures for the three apps carved out of events. Still needs the P14 Postgres rehearsal |
| `D3.1e` | DataTalksClub/website | Rename CustomUser to User (RenameModel, AUTH_USER_MODEL) | D3.1d | no | in-progress | https://github.com/DataTalksClub/website/issues/394 — rebased onto current main as branch `d3.1e-rebased` (b9c0efb3); 0 new failures in both label groups and tests_ci, fresh-database migrate and reverse verified. Originals kept intact. Cannot land until DTC main is green, which is not D3.1's doing: main carries 8 failures, 29 review_import errors from courses.0012_course_prerequisites landing NOT NULL without the fixture following, and 3 tests_ci ownership failures for the three apps carved out of events. Still needs the P14 Postgres rehearsal |
