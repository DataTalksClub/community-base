...
| `D0.1c` | DataTalksClub/website | Copy settings and switch readers and writers | D0.1b | no | blocked | merged as website 3fb9db07; dev deploy blocked on red main CI (website#345, re-run 34681609718 red at resolve-release/ci-gate before the test jobs, verdict gate 34681609984 blocked; the test job itself is green); worker self-check IAM ask resolved (aws-infra#49 closed, grant merged as aws-infra 3acefe43, takes effect with the next website-terraform apply) |
