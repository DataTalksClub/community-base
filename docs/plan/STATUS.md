...
| `C0.4` | community-base | API app: keys with scopes, bearer auth, OpenAPI, route registry | C0.2 | no | in-progress | https://github.com/DataTalksClub/community-base/pull/11 |
