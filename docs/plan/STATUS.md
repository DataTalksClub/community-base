...
| `C5.1e` | community-base | Curriculum ownership: course-owned modules, cohort placement, and nesting | C5.1d | no | in-progress | https://github.com/DataTalksClub/community-base/pull/254 |
