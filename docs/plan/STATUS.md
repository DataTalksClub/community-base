...
| `D1.2a` | DataTalksClub/website | Install the mail app, move PendingUnsubscribe, commit the purpose templates | D1.1, R1.3, R1.4, R1.5 | no | in-progress |  |
| `D1.2b` | DataTalksClub/website | Send through the package mail app with the outbox idempotency keys | D1.2a | no | todo |  |
| `D1.2c` | DataTalksClub/website | Retire the datamailer client, the data app and the studio datamailer views | D1.2b | no | todo |  |
