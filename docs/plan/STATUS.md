...
| `C5.2h` | community-base | Certificate eligibility, learner-requested issuance, and banner-generator artifact seam | C5.2f | no | in-progress | https://github.com/DataTalksClub/community-base/pull/263 |
