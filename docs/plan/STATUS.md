...
| `D1.1` | DataTalksClub/website | Replace DTC jobs with the package jobs app (relay backend) | C1.5, R1.1, R1.2 | no | in-progress | https://github.com/DataTalksClub/website/issues/350 |
