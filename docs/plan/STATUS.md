...
| `C3.6` | community-base | Identity and community capability checkpoint | C3.1e, C3.2, C3.3, C3.4, C3.5a, C3.5b, C3.5c | no | in-progress | https://github.com/DataTalksClub/community-base/pull/96 |
