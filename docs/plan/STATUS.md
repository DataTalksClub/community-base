...
| `C5.2f` | community-base | Peer review assessment modes: per-submission lifecycle, pooled batch formation and assignment | C5.2e | no | in-progress | https://github.com/DataTalksClub/community-base/pull/257 |
| `C5.2g` | community-base | Pooled review expiry and coursework email notifications | C5.2f | no | in-progress | https://github.com/DataTalksClub/community-base/pull/262 |
| `C5.2h` | community-base | Certificate eligibility, learner-requested issuance, and banner-generator artifact seam | C5.2f | no | in-progress | branch c5.2h-certificate-eligibility-request-and-banner-generator, PR pending |
