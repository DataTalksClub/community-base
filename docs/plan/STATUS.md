...
| `C7.10` | community-base | One course parser | C7.9b | no | in-progress | branch `c7.10-one-course-parser`; both old parsers deleted, one `curriculum_course` parser registered over the document toolkit |
