...
| `A0.1` | AI-Shipping-Labs/website | Add the package dependency and the local link targets | C2.4 | no | in-progress | https://github.com/AI-Shipping-Labs/website/issues/1563 |
...
| `D0.1a` | DataTalksClub/website | Install the released kernel and local development tools | C2.4 | no | in-progress | https://github.com/DataTalksClub/website/compare/main...d0.1a-kernel-local-dev-tools |
...
| `D0.2` | DataTalksClub/website | Site CI guard and pin bump workflow | D0.1a | no | todo |  |
...
| `R1.4` | DataTalksClub/relay | Client callbacks for delivery and engagement events | R1.2 | no | in-progress | https://github.com/DataTalksClub/relay/issues/17 |
