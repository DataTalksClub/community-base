...
| `C7.2` | community-base | Shared knowledge base app: wiki and docs | C2.4 | no | in-progress | https://github.com/DataTalksClub/community-base/issues/260 (branch `c7.2-knowledge-base`) |
