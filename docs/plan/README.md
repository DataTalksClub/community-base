...
| 7 | `phase-7.md` | Site convergence: shared wiki and docs, legacy removal, remaining integrate-or-not decisions, one unified content format and one parser toolkit | no production freeze; a one-day content freeze per repository in A7.3 and D7.4 | 2 for the knowledge base, 5 for the rest, nothing for C7.7 | not started |
