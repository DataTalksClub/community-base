...
def register_package_studio():
    ...
    from community_base.comments.studio_registration import register_studio as register_comments
    ...
    from community_base.coursework.studio_registration import register_studio as register_coursework
