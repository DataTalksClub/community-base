...
DEFAULTS = {
    ...
    "CONTENT_SYNC_NULL_MEDIA_URL_PREFIX": "/media/content-sync/",
    ...
    "COURSE_ACCESS_GRANTS": None,
    "COURSEWORK_ANSWER_KEYRING": "",
    "COURSEWORK_CERTIFICATE_GENERATOR": None,
    "COURSEWORK_CERTIFICATE_ISSUED": None,
    "COURSEWORK_DISPLAY_NAME_GENERATOR": None,
    "COURSEWORK_ENROLLMENT_PREFERENCES_UPDATED": None,
    "COURSEWORK_HOMEWORK_SUBMISSION_REJECTED": None,
    "COURSEWORK_HOMEWORK_SUBMITTED": None,
    "COURSEWORK_OPTIONAL_REVIEW_ADDED": None,
    "COURSEWORK_OPTIONAL_REVIEW_DELETED": None,
    "COURSEWORK_PEER_REVIEWS_ASSIGNED": None,
    "COURSEWORK_PEER_REVIEWS_ASSIGNMENT_FAILED": None,
    "COURSEWORK_PROJECT_DELETED": None,
    "COURSEWORK_PROJECT_LEADERBOARD_UPDATER": None,
    "COURSEWORK_PROJECT_SCORED": None,
    "COURSEWORK_PROJECT_SCORING_FAILED": None,
    "COURSEWORK_PROJECT_SUBMITTED": None,
    "COURSEWORK_PROJECT_VOTE_UPDATED": None,
    "COURSEWORK_REGISTRATION_CAMPAIGN_CHANGED": None,
    "COURSEWORK_REGISTRATION_SUBMITTED": None,
    "COURSEWORK_REVIEW_SUBMITTED": None,
    "CALENDLY": False,
    ...
    "EVENT_PRIVACY_NOTICE_VERSION": "1",
    "EVENT_NEWSLETTER_CONSENT_VERSION": "1",
    "EVENT_BANNER_GENERATOR": None,
    "EVENT_RECORDING_PROCESSOR": None,
    "EVENT_RECORDING_READY_HOOK": None,
    "EVENT_WRITEUP_RESOLVER": None,
    "MAIL_BACKEND": "memory",
